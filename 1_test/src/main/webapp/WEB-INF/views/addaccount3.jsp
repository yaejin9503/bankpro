...
function insertaccount(){
	...
	$.ajax({
		type : 'POST',
		url : 'insertloanaccount',
		data : infomation,
		success: function(resp){
			if(resp=='success'){
				alert("대출 계좌 신청이 완료되었습니다.")
			}else{
				alert("대출 계좌 신청 실패했습니다.")
			}
			$("#accountno").val("");
			$("#payment").val("");
			$("#startdeposit").val("");
	...
	<div id="wrap"><!-- wrap -->
		...
		<div id="contents"><!--내용-->
			...
			<ul class="basic_list">
				...
				<li><span>&#47; 계좌번호</span><input type="text" name = "accountno" id = "accountno" class="wr_account"/> <input type="button" value ="계좌번호 발급" id="account"></li>
				<li><span>&#47; 대출금액</span><input type="text" class="wr_account" name = "payment" id = "payment"/></li>
				<li><span>&#47; 대출시작일</span><input type = "date" name ="startdeposit" id ="startdeposit"></li>
				<li><span>&#47; 대출종료일</span><input type = "date" name ="enddeposit" id = "enddeposit"></li>
				<li><span>&#47; 대출이율</span><input type="text" name ="interest" id= "interest" class="wr_account" /></li>

			</ul>

			<br>
			<input type ="button" id="accountM" class="id_check" value ="대출계좌신청">
